...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1436: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1437: (x0,x1,x2) => x0.fetch(x1,x2),
      _1438: (x0,x1) => x0.get(x1),
      _1439: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1439(f,arguments.length,x0,x1,x2) }),
      _1440: (x0,x1) => x0.forEach(x1),
      _1442: () => new AbortController(),
      ...
      _1526: (o, p) => o[p],
      _1529: x0 => x0.random(),
      _1532: () => globalThis.Math,
      _1533: Function.prototype.call.bind(Number.prototype.toString),
      _1534: Function.prototype.call.bind(BigInt.prototype.toString),
      _1535: Function.prototype.call.bind(Number.prototype.toString),
      _1536: (d, digits) => d.toFixed(digits),
      _3414: () => globalThis.window,
      _3475: x0 => x0.navigator,
      _3851: x0 => x0.maxTouchPoints,
      _3861: x0 => x0.platform,
      _3864: x0 => x0.userAgent,
      _6017: x0 => x0.signal,
      _7853: x0 => x0.value,
      _7855: x0 => x0.done,
      _8557: x0 => x0.url,
